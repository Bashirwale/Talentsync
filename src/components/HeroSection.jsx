...
import ava4 from "../assets/Avatar (3).png";

import star from "../assets/Star.svg";

import whiteman from "../assets/whiteman.png";
import ebony from "../assets/ebony.png";
import youngwhite from "../assets/youngwhite.png";
import hijabi from "../assets/hijabi.png";
import youngblack from "../assets/youngblack.png";
    ...
    <div className="flex flex-col lg:flex-row items-center py-10 md:py-16 lg:py-24 lg:mt-24 gap-8 lg:gap-4">
      <div className="flex flex-col gap-12 lg:w-1/2">
        ...
        <div className="flex items-center gap-3 md:gap-5">
          <button className="px-5 py-2 md:px-[28px] md:py-4 text-white text-sm md:text-[18px] font-semibold bg-pryColor rounded-[100px]">
            Start your free trial
          </button>
          <span className="flex items-center gap-2 text-sm md:text-[18px] font-semibold text-pryColor">
            <svg
        ...
        <div className="flex items-center gap-5">
          <div className="flex items-center ">
            <img src={ava1} alt="Avatar" className="-ml-3" />
            <img src={ava2} alt="Avatar" className="-ml-3" />
            <img src={ava3} alt="Avatar" className="-ml-3" />
            <img src={ava4} alt="Avatar" className="-ml-3" />
          </div>
          <div>
