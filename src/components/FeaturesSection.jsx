import grid from "../assets/avatar-grid.png";
const FeaturesSection = () => {
  return (
    <div className="py-10 md:py-16 lg:py-24 relative">
      <p className="text-base md:text-lg text-pryColor font-semibold">
        The ClearLink Advantage
      </p>
      <h2 className="text-gray text-3xl md:text-5xl font-semibold mt-3">
        Why choose ClearLink?
      </h2>
      <p className="text-lg md:text-2xl text-[#667085] font-normal mt-3 md:mt-5 max-w-[796px]">
        In a world where connection is everything, ClearLink takes the lead. Our
        cutting-edge video conferencing app offers:
      </p>
      <div className="flex flex-col lg:flex-row lg:items-center gap-20 lg:gap-12 mt-12 md:mt-16 lg:mt-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-12 md:gap-y-[60px] md:gap-x-10 lg:w-1/2">
